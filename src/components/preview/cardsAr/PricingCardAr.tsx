...
const FEATURES = [
  { label: '20 رمزًا يوميًا', included: true },
  { label: '10 مشاريع', included: true },
  { label: 'الوصول إلى واجهة البرمجة', included: true },
  { label: 'دعم ذو أولوية', included: false },
];

export function PricingCardAr() {
      ...
      <Stack direction="row" sx={{ justifyContent: 'flex-end', mb: 2 }}>
        ...
        >
          ...
          <ToggleButton value="yearly">
            سنوي
            <Chip label="تخفيض" size="small" color="error" sx={{ ml: 1 }} />
          </ToggleButton>
        </ToggleButtonGroup>
      </Stack>
